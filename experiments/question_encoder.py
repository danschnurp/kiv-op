...
def encode_question(question):
    ...
    # tokenizer todo eos_token -> sep , bos_token -> cls
    ...
    encoded_question.data["input_ids"] = torch.reshape(encoded_question.data["input_ids"], (1, encoded_question.data["input_ids"].shape[0]))
